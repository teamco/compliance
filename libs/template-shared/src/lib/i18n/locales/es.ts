export const es = {
  ...
  assets: {
    subtitle: 'Inventario de activos de TI organizacionales',
    addAsset: 'Nuevo activo',
    addDescription:
      'Registrar un activo de TI — servicio, aplicación, infraestructura o dispositivo',
    empty: 'Sin activos registrados',
    name: 'Nombre del activo',
    namePlaceholder: 'ej. Payment API, Customer DB',
    typeLabel: 'Tipo',
    owner: 'Propietario',
